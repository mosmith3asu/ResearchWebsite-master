...
test_views = [
    ...
    {'view': 'surveyPage'},
    ######## INSTRUCTIONS ###############
    {'view': 'beginInstructionsPage'}, # {'view': 'info-frame', 'img': None, 'title': 'Instructions', 'content': TEXT['begin instructions'], 'backButton': False},
    {'view':'movementInstructionsPage'},
    {'view':'turnsInstructionsPage'},
    {'view': 'penaltiesInstructionsPage'},
    {'view': 'objectiveInstructionsPage'},
    ######## PRACTICE ###############
    {'view': 'practicePage'},
    {'view':'canvas-frame'},
    {'view': 'readyPage'},
    ...
    # {'view': 'canvas-frame'},
    # {'view': 'surveyPage'}, #{'view': 'survey-frame'},
    # {'view': 'info-frame', 'img': None, 'title': 'Penalty Information', 'content': TEXT['treatment'],
...
for igame in range(6):
    test_views.append({'view': 'treatmentPage'})
    test_views.append({'view': 'canvas-frame'})
    test_views.append({'view': 'surveyPage'})
test_views.append({'view': 'debriefPage'})
